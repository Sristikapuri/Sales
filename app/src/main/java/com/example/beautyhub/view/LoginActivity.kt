...
fun LoginBody(innerPaddingValues: PaddingValues) {
    ...
    // Peach theme color scheme
    val primaryColor = colorResource(id = R.color.peach_500)
    val peachLight = colorResource(id = R.color.peach_200)
    val peachDark = colorResource(id = R.color.peach_700)
    val backgroundColor = colorResource(id = R.color.peach_background)
    val cardColor = colorResource(id = R.color.peach_surface)
    val textColor = colorResource(id = R.color.text_on_peach)
    val secondaryTextColor = colorResource(id = R.color.secondary_text)
    ...
    Scaffold(
        ...
        Box(
            ...
            Column(
                ...
                Image(
                    painter = painterResource(R.drawable.bbbb), // Beauty Hub logo
                ...
                Card(
                    ...
                    Column(
                        ...
                        OutlinedTextField(
                            ...
                            placeholder = { Text("abc@gmail.com", color = secondaryTextColor) },
                            leadingIcon = {
                                Icon(
                        ...
                        OutlinedTextField(
                            ...
                            placeholder = { Text("*******", color = secondaryTextColor) },
                            leadingIcon = {
                                Icon(
                            ...
                            Row(
                                ...
                                Checkbox(
                                    ...
                                    colors = CheckboxDefaults.colors(
                                        ...
                                        uncheckedColor = peachLight,
                                        checkmarkColor = Color.White,
                                        disabledCheckedColor = peachLight,
                                        disabledUncheckedColor = peachLight,
                                        disabledIndeterminateColor = peachLight
                                    )
                                )
                                Text(
                                    "Remember me",
